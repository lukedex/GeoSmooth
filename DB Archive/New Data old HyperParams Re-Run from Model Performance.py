...
df_loaded=spark.sql("""select * from pricing.IHP_MM_GOCO_CDL_MATCH_FORMODEL_sept""").toPandas()
...
split_train_df, split_val_df = train_test_split(df_loaded, test_size=0.4)
split_val_df, split_test_df = train_test_split(split_val_df, test_size=0.5)
...
X_train = split_train_df.drop([target_col,'hub_timestamp_max','quoteid'], axis=1)
y_train = split_train_df[target_col]

X_val = split_val_df.drop([target_col,'hub_timestamp_max','quoteid'], axis=1)
y_val = split_val_df[target_col]

X_test = split_test_df.drop([target_col,'hub_timestamp_max','quoteid'], axis=1)
